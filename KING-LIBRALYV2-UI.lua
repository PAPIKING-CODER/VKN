    ...
    do 
        ...
        Library.Window = function(self, Data)
            ...
            local Window = {
                ...
                Logo = Data.Logo or Data.logo or "102048765605537", -- REPLACED: default logo ID
            ...
            local Items = { } do
                ...
                if IsMobile then
                    ...
                    -- REPLACED: floating button logo uses new ID (but also will use Window.Logo, which we changed)
                    Items["FloatingLogo"] = Instances:Create("ImageLabel", {
                        Parent = Items["FloatingButton"].Instance,
                        BorderColor3 = FromRGB(0, 0, 0),
                        Name = "\0",
                        Image = "rbxassetid://102048765605537",
                        BackgroundTransparency = 1,
                        AnchorPoint = Vector2New(0.5, 0.5),
                ...
                -- REPLACED: main window logo uses new ID
        ...
        Library.Window = function(self, Data)
            ...
            local Items = { } do
                ...
                if IsMobile then
                    ...
                    -- REPLACED: Floating button icon
                    Items["FloatingLogo"] = Instances:Create("ImageLabel", {
                        Parent = Items["FloatingButton"].Instance,
                        BorderColor3 = FromRGB(0, 0, 0),
                        Name = "\0",
                        Image = "rbxassetid://75793365682618",
                        BackgroundTransparency = 1,
                        AnchorPoint = Vector2New(0.5, 0.5),
                        Position = UDim2New(0.5, 0, 0.5, 0),
                        ZIndex = 127,
            ...
            local Items = { } do
                ...
                if not Data.Parent2.Instance:FindFirstChild("nig") then
                    Items["PaletteIcon"] = Instances:Create("ImageLabel", {
                        ...
                        Size = UDim2New(0, 16, 0, 16),
                        AnchorPoint = Vector2New(0.5, 1),
                        Image = "rbxassetid://75793365682618", -- REPLACED
                        Name = "nig",
                        BackgroundTransparency = 1,
                        Position = UDim2New(1, -16, 1, -6),
                        ZIndex = 2,
